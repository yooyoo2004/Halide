...
private:
    ...
    void visit(const IfThenElse *op) {
        ...
        if (then_acquire &&
            ...
            stmt = Acquire::make(then_acquire->semaphore, then_acquire->count,
