 ...
 * or false inside of it, but definitely false outside of it. */
 ...
 * conservative simplification was made (i.e. the output implies the
 * input, but the input does not imply the output).
 *
 * The condition may be a vector condition, in which case we also
 * 'and' over the vector lanes, and return a scalar result. */
Expr and_condition_over_domain(Expr c,
