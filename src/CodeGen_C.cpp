...
template <typename ElementType_, size_t N>
struct CppVector {
    typedef ElementType_ ElementType;
    enum { Size = N };
    typedef CppVector<ElementType, N> Vec;
    ...
    CppVector(const Vec &src) {
        for (size_t i = 0; i < N; i++) {
            elements[i] = src[i];
        }
    }

    // Could be done more efficiently with variadic templates in C++11, 
    // but generated code doesn't yet require C++11, so we'll do this the old-fashioned way.
    CppVector() {
        for (size_t i = 0; i < N; i++) {
            elements[i] = 0;
        }
    }
    explicit CppVector(const ElementType &a0) {
        static_assert(N == 1, "Wrong ctor");
        elements[0] = a0;
    }
    CppVector(const ElementType &a0,
              const ElementType &a1) {
        static_assert(N == 2, "Wrong ctor");
        elements[0] = a0;
        elements[1] = a1;
    }
    CppVector(const ElementType &a0,
    ...
    CppVector(const ElementType &a0,
              ...
              const ElementType &a2,
              const ElementType &a3,
              const ElementType &a4) {
        static_assert(N == 5, "Wrong ctor");
        elements[0] = a0;
        elements[1] = a1;
        elements[2] = a2;
        elements[3] = a3;
    ...
    CppVector(const ElementType &a0,
              ...
              const ElementType &a3,
              const ElementType &a4,
              const ElementType &a5) {
        static_assert(N == 6, "Wrong ctor");
        elements[0] = a0;
        elements[1] = a1;
        elements[2] = a2;
        elements[3] = a3;
    ...
    CppVector(const ElementType &a0,
              ...
              const ElementType &a4,
              const ElementType &a5,
              const ElementType &a6) {
        static_assert(N == 7, "Wrong ctor");
        elements[0] = a0;
        elements[1] = a1;
        elements[2] = a2;
        elements[3] = a3;
    ...
    CppVector(const ElementType &a0,
              ...
              const ElementType &a5,
              const ElementType &a6,
              const ElementType &a7) {
        static_assert(N == 8, "Wrong ctor");
        elements[0] = a0;
        elements[1] = a1;
        elements[2] = a2;
        elements[3] = a3;
    ...
    static Vec convert_from(const OtherVec &src) {
        static_assert(Vec::Size == OtherVec::Size, "Size mismatch");
        Vec r;
        for (size_t i = 0; i < N; i++) {
            r.elements[i] = static_cast<Vec::ElementType>(src[i]);
        }
        return r;
    }
...
struct NativeVector {
    typedef ElementType_ ElementType;
    enum { Size = N };
    typedef NativeVector<ElementType, N> Vec;
    ...
    explicit NativeVector(const NativeVectorType &src) {
        native_vector = src;
    }
    ...
    explicit NativeVector(const ElementType &a0) {
        static_assert(N == 1, "Wrong ctor");
        native_vector = { a0 };
    }
    NativeVector(const ElementType &a0,
              const ElementType &a1) {
        static_assert(N == 2, "Wrong ctor");
        native_vector = { a0, a1 };
    }
    ...
    NativeVector(const ElementType &a0,
              ...
              const ElementType &a5) {
        static_assert(N == 6, "Wrong ctor");
        native_vector = { a0, a1, a2, a3, a4, a5 };
    }
    NativeVector(const ElementType &a0,
              const ElementType &a1,
              const ElementType &a2,
              ...
              const ElementType &a6) {
        static_assert(N == 7, "Wrong ctor");
        native_vector = { a0, a1, a2, a3, a4, a5, a6 };
    }
    NativeVector(const ElementType &a0,
              const ElementType &a1,
              const ElementType &a2,
              ...
              const ElementType &a7) {
        static_assert(N == 8, "Wrong ctor");
        native_vector = { a0, a1, a2, a3, a4, a5, a6, a7 };
    }
    ...
    friend Vec operator+(const Vec &a, const Vec &b) {
        return NativeVector(a.native_vector + b.native_vector);
    }
    friend Vec operator-(const Vec &a, const Vec &b) {
        return NativeVector(a.native_vector - b.native_vector);
    }
    ...
    friend Vec operator+(const Vec &a, const ElementType &b) {
        return NativeVector(a.native_vector + b);
    }
    friend Vec operator-(const Vec &a, const ElementType &b) {
        return NativeVector(a.native_vector - b);
    }
    ...
    friend Vec operator+(const ElementType &a, const Vec &b) {
        return NativeVector(a + b.native_vector);
    }
    friend Vec operator-(const ElementType &a, const Vec &b) {
        return NativeVector(a - b.native_vector);
    }
    ...
    static Vec convert_from(const OtherVec &src) {
        ...
        return NativeVector(__builtin_convertvector(src.native_vector, NativeVectorType));
#else
        Vec r;
        for (size_t i = 0; i < N; i++) {
            r.native_vector[i] = static_cast<Vec::ElementType>(src.native_vector[i]);
        }
        return r;
#endif
    }
