...
void CodeGen_Hexagon::compile_func(const LoweredFunc &f,
    ...
    // patterns for vtmpy and also saves us from re-rerunning CSE pass after
    // vtmpy_generator
    ...
    body = undo_bad_slice_vector_hoisting(body, target);
    debug(2) << "Lowering after undoing bad slice_vector_hoisting: " << body << "\n\n";
